...
/*   Updated: 2025/07/05 15:38:13 by mszymcza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	chiant = read_map("map.ber", col_count("map.ber"), count_line("map.ber"), &blabla);
//	if (validate_map(chiant,  col_count("map.ber"), count_line("map.ber")))
//		printf ("OUIIIIIIII\n");
//	else 
//		printf ("nooon coco!\n");
//	print_map(chiant, col_count("map.ber"), count_line("map.ber"));
//	free_map (chiant);
//}
...
static void	load_images(t_game *game)
{
	...
	size = TILE_SIZE;
	game->player.data = mlx_xpm_file_to_image(game->mlx, "assets/player.xpm", &size, &size);
	game->wall.data = mlx_xpm_file_to_image(game->mlx, "assets/wall.xpm", &size, &size);
	game->floor.data = mlx_xpm_file_to_image(game->mlx, "assets/floor.xpm", &size, &size);
	game->collect.data = mlx_xpm_file_to_image(game->mlx, "assets/collectible.xpm", &size, &size);
	game->exit.data = mlx_xpm_file_to_image(game->mlx, "assets/exit.xpm", &size, &size);
